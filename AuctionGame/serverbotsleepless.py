...
numbidders = 4 #change this for how many bots you want to play with
...
#for some reason, the next line(LINE 52) breaks python and stops anything from happening whatsoever
